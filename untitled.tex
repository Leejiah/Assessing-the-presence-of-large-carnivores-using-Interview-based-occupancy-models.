...
Due to the high levels of household replacement the original grid selected does not represent the most effective division of households into study sites. To calculate optimal grid placement, given the optimum numbers of surveys to conduct per site (Table \ref: ta) 
