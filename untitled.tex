...
\begin{table}[h]
	...
	\begin{center}
		\begin{tabular}{l p{3cm} p{3cm} p{5cm}}
			...
			\hline \hline						
		\end{tabular}
		\caption{Optimum number of surveys required at each site from \protect\cite{MACKENZIE_2005}. Estimated occupancy and detection probabilities were based on the expert opinion of RCP staff.}
