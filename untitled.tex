...
High levels of household replacement means the original 6x6km gridding was not considered relevant. Optimal grid placement was explored by laying a 5x5, 6x6 and 7x7km grids across the survey landscape. The grids were then moved horizontally, vertically and diagonally in 100m increments and the average and standard deviation of numbers of households in each grid examined. The optimal grid placement was that which ensured as many grids as possible meet the optimum number of households (Table \ref{table:OptimumRepeats}) ca


deemed to have a mean above and as close to 5 as possible and a low standard deviation.
