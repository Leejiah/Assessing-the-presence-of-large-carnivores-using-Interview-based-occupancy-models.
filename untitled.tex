...
Ruaha National Park forms the core of the Ruaha-Rungwa ecosystem, however much of the village land surrounding the park forms habitat for large carnivores and potentially provides valuable connectivity with other protected areas \cite{Abade_2014a}. The communities living around the park are ethnically diverse coming from at least 35 different ethnic groups \cite{Williams2005}. For many people livelihood strategies are tied strongly to cultural and tribal identities \cite{Williams2005,Dickman2008} with a number of these ethnic group's livelihoods relying heavily on livestock herding \cite{Dickman2008}.\\
