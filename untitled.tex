...
Negative human-wildlife interactions (HWI) (used here in preference over human-wildlife conflict phrasing see \citet{Peterson_2010} \& \citet{Redpath_2014}) is one the greatest challenges faced by the global conservation movement \cite{Dickman_2010,Redpath2014}. They can impart high social, economic and emotional costs on the human-communities living alongside problematic wildlife \cite{Dickman_2010,Barua_2013}, and are costly for wildlife as management (legal or illegal) often entails blocking their access to important resources or lethal control \cite{Dickman_2010}
