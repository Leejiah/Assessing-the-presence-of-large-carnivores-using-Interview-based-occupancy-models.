...
Due to the high levels of household replacement the original grid selected does not represent the most effective division of households into study sites. To calculate optimal grid placement, given the optimum numbers of surveys to conduct per site (Table \ref{table:OptimumRepeats}) a series of grid sizes and placements were tested. A grid with 25km$^2$ sized squares was placed across the landscape, the grid was then offset by 100m increments in three directions ((x+100, y); (x, y+100), (x+100,y+100)), this was repeated for grids with 36 and 49km$^2$ sized squares. The optimal grid placement was defined as having a mean above 5 but as close to 5 as possible to ensure optimum distr
